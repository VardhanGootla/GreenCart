    ...
    product && (
      <div className="mt-12">
        ...
        <div className="flex flex-col items-center mt-20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-16 lg:grid-cols-5 mt-6 w-full">
            {relatedProducts
              .filter((p) => p.inStock)
              .map((product, index) => (
          ...
          <button
            ...
            className="mx-auto cursor-pointer px-12 my-16 py-2.5 border text-primary hover:bg-primary/10 transition"
          >
            See More
          </button>
        </div>
